        ...
        opcode_map =
            {
                ...
                {0x0F, OpcodeCommand(" RrcA a", std::bind(&Opcode::RrcA, this, CPU->A), 4)},
                // rotate left
                ...
                {0x17, OpcodeCommand(" Rla a", std::bind(&Opcode::Rla, this, CPU->A), 4)},
                // rotate right
                ...
                {0x1F, OpcodeCommand(" RrA a ", std::bind(&Opcode::RrA, this, CPU->A), 4)},
                // shift left
